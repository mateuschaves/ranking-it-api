...
export class RankingScoreController {
    constructor(
        private readonly rankingItemScoreService: RankingScoreService
    ) {}
    ...
    async createRankingScore(
        ...
        return await this.rankingItemScoreService.createRankingScore(createRankingScoreDto);
    }
    ...
    async getRankingScores(
        ...
        return await this.rankingItemScoreService.getRankingItemScores(rankingItemId);
    }
}
